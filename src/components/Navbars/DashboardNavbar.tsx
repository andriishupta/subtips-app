          ...
          <form className="mr-3 hidden flex-row flex-wrap items-center md:flex lg:ml-auto">
            <div className="relative flex w-full flex-wrap items-stretch">
              ...
              <input
                ...
                className="relative w-full rounded border-0 bg-white bg-white px-3 py-3 pl-10 text-sm text-slate-600 placeholder-slate-300 shadow outline-none focus:outline-none focus:ring"
              />
            </div>
          </form>
          {/* User */}
