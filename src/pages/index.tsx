  ...
  return (
    <>
      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="mt-32 flex flex-wrap items-center">
              <div className="mr-auto ml-auto w-full px-4 md:w-5/12">
                ...
                <Link
                  href="/src/pages"
                  className="mt-8 font-bold text-slate-700"
                >
                  Check Notus NextJS!
                </Link>
              </div>
              ...
              <div className="mr-auto ml-auto w-full px-4 md:w-4/12">
                <div className="relative mb-6 flex w-full min-w-0 flex-col break-words rounded-lg bg-white bg-slate-700 shadow-lg">
                  <img
                    alt="..."
            ...
            <div className="flex flex-wrap items-center">
              ...
              <div className="ml-auto mr-auto w-full px-4 md:w-5/12">
                <div className="md:pr-12">
                  <div className="mb-6 inline-flex h-16 w-16 items-center justify-center rounded-full bg-slate-200 p-3 text-center text-slate-500 shadow-lg">
                  ...
                  <ul className="mt-6 list-none">
                    <li className="py-2">
                      <div className="flex items-center">
                        <div>
                          <span className="mr-3 inline-block rounded-full bg-slate-100 py-1 px-2 text-xs font-semibold uppercase text-slate-500">
                            <i className="fas fa-fingerprint"></i>
                          </span>
                        </div>
                        <div>
                ...
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    ...
                    <div className="mt-6">
                      ...
                      <button
                        className="mr-1 mb-1 h-8 w-8 rounded-full bg-sky-600 text-white outline-none focus:outline-none"
                        type="button"
                      >
                ...
                <div className="px-6">
                  ...
                  <div className="pt-6 text-center">
                    ...
                    <div className="mt-6">
                      ...
                      <button
                        className="mr-1 mb-1 h-8 w-8 rounded-full bg-slate-700 text-white outline-none focus:outline-none"
                        type="button"
                      >
        ...
        <section className="relative block bg-slate-800 pb-20">
          <div
            className="pointer-events-none absolute bottom-auto top-0 left-0 right-0 -mt-20 h-20 w-full overflow-hidden"
            style={{ transform: 'translateZ(0)' }}
          >
          ...
          <div className="container mx-auto px-4 lg:pt-24 lg:pb-64">
            ...
            <div className="mt-12 flex flex-wrap justify-center">
              <div className="w-full px-4 text-center lg:w-3/12">
                <div className="inline-flex h-12 w-12 items-center justify-center rounded-full bg-white p-3 text-slate-800 shadow-lg">
        ...
        <section className="relative block bg-slate-800 py-24 lg:pt-0">
          <div className="container mx-auto px-4">
                  ...
                  <div className="flex-auto p-5 lg:p-10">
                    ...
                    <div className="relative mb-3 w-full">
                      ...
                      <textarea
                        rows={4}
                        cols={80}
                        className="w-full rounded border-0 bg-white px-3 py-3 text-sm text-slate-600 placeholder-slate-300 shadow focus:outline-none focus:ring"
                        placeholder="Type a message..."
                      />
                    </div>
                    <div className="mt-6 text-center">
                      <button
                        className="mr-1 mb-1 rounded bg-slate-800 px-6 py-3 text-sm font-bold uppercase text-white shadow outline-none transition-all duration-150 ease-linear hover:shadow-lg focus:outline-none active:bg-slate-600"
                        type="button"
                      >
                        Send Message
                      </button>
